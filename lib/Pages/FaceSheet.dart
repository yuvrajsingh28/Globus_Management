...
import 'package:globus_management/Pages/Components/Toggle_Bar.dart';
import 'package:intl/intl.dart';

class FaceSheet extends StatefulWidget {
  @override
  _FaceSheetState createState() => _FaceSheetState();
}

class _FaceSheetState extends State<FaceSheet> {
                      ...
                      child: Neumorphic(
                        ...
                        child: ListView(
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(10, 10, 300, 10),
                              child: Container(
                                width: 200,
                                height: 40,
                                child: Neumorphic(
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(10, 10, 800, 10),
                              child: Container(
                                width: 100,
                                height: 40,
                                child: Neumorphic(
